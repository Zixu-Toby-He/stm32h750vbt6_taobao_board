...
static void msghandler_default(uint8_t msg);
void (*_msghandler_usart_)(uint8_t) = msghandler_default;
...
void uart_init(uint32_t baudrate, void (*__msghandler__)(uint8_t)) {
    // 更新消息处理器
    _msghandler_usart_ = __msghandler__;
