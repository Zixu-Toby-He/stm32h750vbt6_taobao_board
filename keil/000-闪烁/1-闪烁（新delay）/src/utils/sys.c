...
void Cache_Enable(void)
{
	...
	SCB->CACR |= 1 << 2;  // 强制 D-Cache 透写如不开启,实际使用中可能遇到各种问题
}
...
void Stm32_Clock_Init(u32 plln,u32 pllm,u32 pllp,u32 pllq)
{
	...
	RCC_OscInitStruct.PLL.PLLN = plln; // 有效值：1 ~ 512
	RCC_OscInitStruct.PLL.PLLM = pllm; // 有效值：1 ~ 64
	RCC_OscInitStruct.PLL.PLLP = pllp; // 有效值：1 ~ 128
	RCC_OscInitStruct.PLL.PLLQ = pllq; // 有效值：1 ~ 128
