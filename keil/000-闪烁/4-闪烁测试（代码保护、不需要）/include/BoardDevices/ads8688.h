...
#define VREF_U_25       0x05    // 通道输入范围  2.5   * VREF
#define VREF_U_125      0x06    // 通道输入范围  1.25  * VREF

//-----------------------------------------------------------------
// 引脚配置
//-----------------------------------------------------------------
#define RST_L      HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13,  GPIO_PIN_RESET)
#define RST_H      HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13,  GPIO_PIN_SET)
#define DAISY_L    HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3,   GPIO_PIN_RESET)
#define DAISY_H    HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3,   GPIO_PIN_SET)
#define CS_L       HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4,   GPIO_PIN_RESET)
#define CS_H       HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4,   GPIO_PIN_SET)
...
// ((double)(data - 32768)) * 10240.0 / 65536;
#define ADS8688_data2millivolt(data) ((double)((data) - 32768)) * (5.0 / 32)
extern double  Get_MAN_CH_Data_MilliVolt(uint16_t ch);
