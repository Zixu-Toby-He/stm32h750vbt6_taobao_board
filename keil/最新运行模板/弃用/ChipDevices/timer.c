...
void (*time_out_handler_tim3)(void);
...
// Ft=定时器工作频率,单位:Mhz
// 当前使用的是定时器 3（定时器3挂在APB1上，时钟为HCLK/2）
void TIM3_Init(u16 arr, u16 psc, void (*_time_out_handler_)(void))
{
...
// arr：自动重装值
// psc：时钟预分频数
void TIM3_PWM_Init(u16 arr, u16 psc, void (*_time_out_handler_)(void))
{
	time_out_handler_tim3           = _time_out_handler_;
